 ...
 * @param {String[]}  opts.verified   verifiable claims to be requested from the user (i.e. signed by someone else, for example passport ...)
 */
export function requestDisclosure({ requested = ["name", "country", "email", "image", "phone"], verified }) {
